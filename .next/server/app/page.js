...
/* harmony import */ var next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 6404)), "/Users/serkankara/Desktop/TakeHomeTest-FED-SR/src/app/page.tsx"],
          metadata: {
    ...
    manifest: undefined
        ...
        {
          'layout': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 4180)), "/Users/serkankara/Desktop/TakeHomeTest-FED-SR/src/app/layout.tsx"],
          metadata: {
    icon: [(async (props) => (await Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 1764))).default(props))],
    apple: [],
    openGraph: [],
    ...
    const pages = ["/Users/serkankara/Desktop/TakeHomeTest-FED-SR/src/app/page.tsx"];
...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 9179))
...
var layout_tsx_import_Inter_arguments_subsets_latin_variableName_inter_ = __webpack_require__(5191);
...
const SideBar = ({ setPanelOpen , isPanelOpen  })=>{
    return /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
        className: "flex flex-col flex-1 bg-slate-200 items-center pt-4",
        children: [
            /*#__PURE__*/ jsx_runtime_.jsx("button", {
                onClick: ()=>setPanelOpen(!isPanelOpen),
                children: /*#__PURE__*/ jsx_runtime_.jsx(Bars3Icon, {
        ...
        children: [
            ...
            /*#__PURE__*/ jsx_runtime_.jsx(transition/* Transition */.u, {
                ...
                children: /*#__PURE__*/ jsx_runtime_.jsx(popover/* Popover.Panel */.J.Panel, {
                    ...
                    children: /*#__PURE__*/ jsx_runtime_.jsx("div", {
                        className: "flex flex-wrap bg-white rounded-md justify-between px-4 py-4",
                        children: /*#__PURE__*/ jsx_runtime_.jsx("div", {
                            className: "grow w-[33%] flex items-center justify-center bg-red-200 rounded-lg mb-4",
                            children: /*#__PURE__*/ jsx_runtime_.jsx(AcademicCapIcon, {
                                className: "h-6 w-6 text-black focus:outline-none"
                            })
                        })
                    })
...
// EXTERNAL MODULE: ./node_modules/@heroicons/react/24/outline/MagnifyingGlassCircleIcon.js
...
const SearchInput = ()=>{
    ...
    return /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
        ...
        children: [
            /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                className: "flex bg-slate-200 rounded-xl w-full relative items-center px-10",
                children: [
                    /*#__PURE__*/ jsx_runtime_.jsx(MagnifyingGlassCircleIcon, {
                        className: "absolute left-3 h-6 w-6 text-slate-600 focus:outline-none"
                    }),
                    ...
                    /*#__PURE__*/ jsx_runtime_.jsx("button", {
                        ...
                        children: /*#__PURE__*/ jsx_runtime_.jsx(AdjustmentsHorizontalIcon, {
                            className: " h-6 w-6 text-slate-600 focus:outline-none"
                        })
                    })
                ]
            }),
            /*#__PURE__*/ jsx_runtime_.jsx("div", {
                className: `${isSearchSettingsOpen ? "block" : "hidden"} absolute top-10 bg-white w-full`,
                children: "Search bar"
            })
        ]
    });
...
// EXTERNAL MODULE: ./node_modules/@heroicons/react/24/outline/BeakerIcon.js
...
;// CONCATENATED MODULE: ./src/components/containers/Navigation/index.tsx




const Navigation = ({ setIsSettingsOpen , isSettingsOpen  })=>{
    return /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
        className: "bg-slate-100 flex py-4 space-x-2",
        children: [
            /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                className: "flex items-center w-64 px-4",
                children: [
                    /*#__PURE__*/ jsx_runtime_.jsx(BeakerIcon, {
                        className: "h-8 w-8 text-black focus:outline-none"
                    }),
            ...
            /*#__PURE__*/ jsx_runtime_.jsx("button", {
                ...
                children: /*#__PURE__*/ jsx_runtime_.jsx(Cog6ToothIcon, {
                    className: "h-6 w-6 text-black focus:outline-none"
                })
            }),
...
;// CONCATENATED MODULE: ./src/components/containers/SettingsMenu/index.tsx
...
const SettingsMenu = ({ isSettingsOpen  })=>{
    return /*#__PURE__*/ jsx_runtime_.jsx("div", {
        ...
        children: /*#__PURE__*/ jsx_runtime_.jsx("div", {
            ...
            children: /*#__PURE__*/ jsx_runtime_.jsx("div", {
                className: "bg-white rounded-lg flex-1 p-2",
...
function RootLayout({ children  }) {
    const [isPanelOpen, setIsPanelOpen] = (0,react_.useState)(false);
    const [isSettingsOpen, setIsSettingsOpen] = (0,react_.useState)(false);
                    ...
                    /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                                ...
                                children: [
                                    /*#__PURE__*/ jsx_runtime_.jsx(CollapsibleMenu, {
                                        isOpen: isPanelOpen
                                    }),
                                    /*#__PURE__*/ jsx_runtime_.jsx("div", {
                                        className: "w-full",
...
const proxy = (0,next_dist_build_webpack_loaders_next_flight_loader_module_proxy__WEBPACK_IMPORTED_MODULE_0__.createProxy)(String.raw`/Users/serkankara/Desktop/TakeHomeTest-FED-SR/src/app/layout.tsx`)
...
const proxy = (0,module_proxy.createProxy)(String.raw`/Users/serkankara/Desktop/TakeHomeTest-FED-SR/src/components/containers/TabContainer/index.tsx`)
...
// is a client boundary.
const { __esModule, $$typeof } = proxy;
/* harmony default export */ const TabContainer = (proxy.default);

const e0 = proxy["TabContainer"];
...
var __webpack_exports__ = __webpack_require__.X(0, [79,961], () => (__webpack_exec__(9705)));
